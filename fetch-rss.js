...
const RSS_SOURCES = [
  ...
  { id: "middleeasteye", name_en: "Middle East Eye",name_fa: "میدل ایست آی",  url: "https://www.middleeasteye.net/rss/section/news" },
  { id: "arabnews",      name_en: "Arab News",      name_fa: "عرب نیوز",       url: "https://www.arabnews.com/cat/3/rss.xml" },
  // === منابع ایرانی ===
  ...
  { id: "tabnak",        name_en: "Tabnak",         name_fa: "تابناک",         url: "https://www.tabnak.ir/rss" },
  { id: "farsnews",      name_en: "Fars News",      name_fa: "فارس",           url: "https://www.farsnews.ir/rss/news" },
  { id: "entekhab",      name_en: "Entekhab",       name_fa: "انتخاب",         url: "https://www.entekhab.ir/rss" },
  { id: "donya_eqtesad", name_en: "Donya-e Eqtesad",name_fa: "دنیای اقتصاد",  url: "https://www.donya-e-eqtesad.com/rss/1" },
  { id: "eghtesadnews",  name_en: "Eghtesad News",  name_fa: "اقتصادنیوز",    url: "https://www.eghtesadnews.com/rss" },
  { id: "alef",          name_en: "Alef",           name_fa: "الف",            url: "https://alef.ir/rss" },
];
...
async function fetchRSS(source) {
  try {
    ...
    // پاکسازی XML برای منابع ایرانی
    const cleanXml = xml
      .replace(/&(?!(amp|lt|gt|quot|apos|#\d+|#x[0-9a-fA-F]+);)/g, '&amp;')
      .replace(/<!\[CDATA\[[\s\S]*?\]\]>/g, m => m)
